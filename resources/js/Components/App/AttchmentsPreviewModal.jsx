...
const AttchmentsPreviewModal = ({attachments, 
    index, 
    show=false, 
    onClose = () => { }
}) => {
    ...
    return (
        <Transition show={show} as={Fragment} leave="duration-200">
            ...
            <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                    <Dialog.Panel className="flex flex-col w-full h-full align-middle transform overflow-hidden rounded-2xl bg-slate-800 p-6 text-left align-middle shadow-xl transition-all">
                        <button
                            onClick={close}
                            className="absolute right-3 w-10 h-10 rounded-full hover:bg-black transition flex items-center justify-center text-gray-100 z-40">
                            ...
                            {attachment && (
                                <div className="flex items-center justify-center w-full h-full p-3">
                                    {isImage(attachment) && (
                                        ...
                                        className="max-w-full max-h-full" alt="" />
                                    )}
...
export default AttchmentsPreviewModal;